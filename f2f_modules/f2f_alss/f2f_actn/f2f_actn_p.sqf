...
// ---------- OPFOR ----------
	...
	case "L39_TK_EP1_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","L39_TK_EP1_back",38);
	};
	// ---------- "Su25_CDF" Su-25 [CDF] ----------
	case "Su25_CDF_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Su25_CDF_back",37);
	};
	...
	case "Su25_Ins_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Su25_Ins_back",37);
	};
	// ---------- "Su39" Su-25 [Russia] ----------
	case "Su39_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Su39_back",37);
	};
	...
	case "Su25_TK_EP1_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Su25_TK_EP1_back",37);
	};
	// ---------- "Su34" Su-34 ----------
	case "Su34_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Su34_back",36);
	};
// ---------- BLUFOR ----------
	// ---------- "A10" A-10 [USMC] ----------
	case "A10_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","A10_back",36);
	};
	// ---------- "A10_US_EP1" A-10 [US] ----------
	case "A10_US_EP1_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","A10_US_EP1_back",36);
	};
	...
	case "AV8B_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","AV8B_back",35);
	};
...
// ------------------------------------------
	...
	case "F2F_F18C3_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","F2F_F18C_back",35);
	};
	...
	case "EF2000BW_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","EF2000BW_back",36);
	};	
	...
	case "F15E_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","F15E_back",36);
	};
	...
	case "F15C_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","F15C_back",38);
	};
	...
	case "TFB_OV10_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","TFB_OV10_back",38);
	};	
	...
	case "OV10_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","OV10_back",38);
	};
	// ---------- "ACE_Su34" Su-34 ACE ----------
	case "ACE_Su34_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Su34_back",36);
	};
	// ---------- "ACE_Su25" Su-25 ACE ----------
	case "ACE_Su25_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Su25_back",37);
	};
	// ---------- "ACE_Su39" Su-25 ACE ----------
	case "ACE_Su39_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Su39_back",37);
	};
	// ---------- "ACE_A10" A-10 ACE ----------
	case "ACE_A10_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_A10_back",36);
	};
	// ---------- "ACE_L39" L-39 ACE ----------
	case "ACE_L39_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_L39_back",37);
	};
	// ---------- "rksl_efa_fgr4" FGR4 ----------
	case "rksl_efa_fgr4_mm":
	{
		ACTN_RD(actn_rksl_efa_fgr4_sm_1,_tgt,"Air Superiority","f2f_actn\f2f_actn_p.sqf","rksl_efa_fgr4_as_sm",40);
		ACTN_RD(actn_rksl_efa_fgr4_sm_2,_tgt,"LGB","f2f_actn\f2f_actn_p.sqf","rksl_efa_fgr4_lgb_sm",39);
		ACTN_RD(actn_rksl_efa_fgr4_sm_3,_tgt,"Swing Role","f2f_actn\f2f_actn_p.sqf","rksl_efa_fgr4_sr_sm",38);
		ACTN_RD(actn_rksl_efa_fgr4_sm_4,_tgt,"SEAD","f2f_actn\f2f_actn_p.sqf","rksl_efa_fgr4_sead_sm",37);
		ACTN_RD(actn_rksl_efa_fgr4_sm_5,_tgt,"Close Air Support","f2f_actn\f2f_actn_p.sqf","rksl_efa_fgr4_cas_sm",36);
		ACTN_RD(actn_rksl_efa_fgr4_sm_6,_tgt,"Maritime Strike","f2f_actn\f2f_actn_p.sqf","rksl_efa_fgr4_ms_sm",35);
		ACTN_RD(actn_rksl_efa_fgr4_sm_7,_tgt,"Anti Armour","f2f_actn\f2f_actn_p.sqf","rksl_efa_fgr4_aa_sm",34);
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","rksl_efa_fgr4_back",30);
	};
	case "rksl_efa_fgr4_as_sm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","rksl_efa_fgr4_back",38);
	};
	case "rksl_efa_fgr4_lgb_sm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","rksl_efa_fgr4_back",37);
	};
	...
	case "rksl_efa_fgr4_aa_sm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","rksl_efa_fgr4_back",36);
	};
	...
	case "GLT_Su34_JDAM_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","GLT_Su34_JDAM_back",35);
	};
	...
	case "GLT_Su34_Laser_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","GLT_Su34_Laser_back",35);
	};
	...
	case "GLT_Su39_JDAM_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","GLT_Su39_JDAM_back",36);
	};
	...
	case "GLT_Su39_laser_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","GLT_Su39_laser_back",36);
	};
	...
	case "vmfa_aw533_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","vmfa_aw533_back",34);
	};
	...
	case "vfa_14_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","vfa_14_back",34);
	};	
	...
	case "no_1sqn_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","no_1sqn_back",34);
	};
	...
	case "14US_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","14US_back",35);
	};
	...
	case "HarrierGR3_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","HarrierGR3_back",35);
	};
	...
	case "HarrierGR3s_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","HarrierGR3s_back",35);
	};
	...
	case "GLT_F16C_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","GLT_F16C_back",32);
	};
	...
	case "AV8B2_JDAM_ai_sm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Back to Index","f2f_actn\f2f_actn_back.sqf","AV8B2_JDAM_ai_back",35);
	};
	...
	case "A10_US_EP1_JDAM_ai_sm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Back to Index","f2f_actn\f2f_actn_back.sqf","A10_US_EP1_JDAM_ai_back",35);
	};
// ------------------------------------------
